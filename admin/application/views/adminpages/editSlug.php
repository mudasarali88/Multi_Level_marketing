...
<div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="active">Edit Salogen</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Edit Salogen</h1>
    <!-- end page-header -->
            ...
            <?php } ?>
                ...
                <form class="form-horizontal fv-form fv-form-bootstrap row col-md-12"  name="AddSlider" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group m-b-10">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" name="slugheading" value="<?= $slug['slugheading'];?>">
                        </div>
                    ...
                    <div class="form-group m-b-10">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" name="slugtext" value="<?= $slug['slugtext'];?>">
                            <input type="hidden" class="form-control" name="slugId" value="<?= $slug['slugId'];?>">
                        </div>
                    ...
                    <div class="form-group m-b-10">
                        ...
                        <div class="col-md-5">
                            <input type="file" class="form-control" name="slugImg" value="<?= $slug['slugImage'];?>">
                        </div>
