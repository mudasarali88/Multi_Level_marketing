            ...
            <div class="col-md-10">
                ...
                <form class="form-horizontal fv-form fv-form-bootstrap row col-md-12"  name="Country" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group m-b-10">
                        <label class="col-md-3 control-label">Sort Name </label>
                        <div class="col-md-5">
                            <input type="text" class="form-control"  name="sort_name" required="" value="<?= $country[0]['sortname'] ?>" placeholder="Enter Category"  data-parsley-required="true">
                        </div>
                        <div class="col-md-4">
              ...
              <div class="form-group m-b-10">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control"  name="name"  value="<?= $country[0]['name'] ?>"  data-parsley-required="true">
                        </div>  
                        <div class="col-md-4">
                            <div class="text-danger">
                    ...
                    <div class="form-group m-b-10">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control"  name="phone_code"  value="<?= $country[0]['phonecode'] ?>"  data-parsley-required="true">
                        </div>  
                        <div class="col-md-4">
                            <div class="text-danger">
