...
<div id="content" class="content">
    ...
    <div class="row">
        ...
        <div class="section-container section-with-top-border p-b-10">
            ...
            <div class="col-md-10">
                <a href="<?= base_url()."categories"?>" class="btn btn-primary pull-right"><i class="fa fa-plus-circle"></i> Add category</a>
            <div class="message col-md-8">
                <?php if ($this->session->flashdata('message')) { ?>
                    <?= $this->session->flashdata('message') ?>
                <?php } ?>
                </div>
            <form action="subCategories" class="form-horizontal fv-form fv-form-bootstrap row col-md-12"   name="subcat_title" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group m-b-10">
                    ...
                    <div class="form-group m-b-10">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control"  name="subcat_title" required="" value="<?php echo set_value('subcat_title'); ?>" placeholder="Enter SubCategory"  data-parsley-required="true">
                        </div>
                        <div class="col-md-4">
                            <div class="text-danger">
    ...
    <div class="row m-t-20">
        ...
        <div class="section-container section-with-top-border">
            ...
            <div class="form-group m-b-10 col-md-12">
                ...
                <div class="col-md-5">
                    <select class="form-control"  name="" onchange="javascript:if($(this).val() !=''){window.location.href='<?= base_url() ?>E_categories/subCategories/'+$(this).val();}">
