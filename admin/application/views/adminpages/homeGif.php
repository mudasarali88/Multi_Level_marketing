...
<div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="active">Add Gif</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Add Gif</h1>
    <!-- end page-header -->
            ...
            <?php } ?>
                ...
                <form class="form-horizontal fv-form fv-form-bootstrap row col-md-12"  name="AddSlider" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group m-b-10">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" name="gifTitle">
                        </div>
                    ...
                    <div class="form-group m-b-10">
                        ...
                        <div class="col-md-5">
                            <input type="file" class="form-control" name="gifImg">
                        </div>
            ...
            <div class="panel pagination-inverse clearfix m-b-0">
                <table id="data-table"  class="table table-bordered table-hover">
                    ...
                    foreach ($gifs as $item) {
                        $i++; ?>
                        <tr class="odd gradeX" id="row_<?= $item['gifId'] ?>">
                            <td><?= $i ?></td>
                            <td><p><?= $item['gifTitle'] ?></p></td>
                            <td><p><img src="<?=base_url()?>assets/images/gifImages/<?= $item['gifImg'] ?>" width="70"></p></td>
                            <td><?php if ($item['gifstatus'] == '1'): ?>
                                <a href="<?= base_url()?>Admin/updateGif/0/<?= $item['gifId'] ?>"><label class="label-success label_adj" data-toggle="tooltip" title="click to deactivate!">Active</label></a>
                            <?php else: ?>
                                <a href="<?= base_url()?>Admin/updateGif/1/<?= $item['gifId'] ?>"><label class="label-warning label_adj" data-toggle="tooltip" title="click to activate!">deactive</label></a>
                            <?php endif ?>
                        </td>
                        <td>
                                <?php if($item['isGlobal']=='1'): ?>
                                <a href="<?=base_url()?>admin/changeGifGlobalStatus/0/<?=$item['gifId']?>"><img src="<?=base_url()?>assets/images/on.png" width="20" title="Click to change Global Status"></a>
                                <?php else: ?>
                                <a href="<?=base_url()?>admin/changeGifGlobalStatus/1/<?=$item['gifId']?>"><img src="<?=base_url()?>assets/images/off.png" width="20" title="Click to change Global Status"></a>
                                <?php endif; ?>
                                    
                            </td>
                            <td>
                                <a onclick="confirm('Are you sure??')" href="<?= base_url()?>admin/deleteGif/<?= $item['gifId'] ?>" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-trash"></i> Delete</a>
                                <a href="<?= base_url()?>admin/EditGif/<?= $item['gifId'] ?>" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-edit"></i> edit</a>
                            </td>
                        </tr>
                    <?php }} ?>
