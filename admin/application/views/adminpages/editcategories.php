...
?>
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Edit Plan</h1>
    <!-- end page-header -->
    <!-- begin row -->
    <div class="row">
        ...
        <div class="section-container section-with-top-border p-b-10">
            ...
            <div class="col-md-10">
                ...
                <form class="form-horizontal fv-form fv-form-bootstrap row col-md-12"  name="Category" method="post" enctype="multipart/form-data">

                    <div class="form-group m-b-10">
                        <label class="col-md-3 control-label">Plan title </label>
                        <div class="col-md-5">
                            <input type="text" class="form-control"  name="cat_title" required="" value="<?= $category[0]['cat_title'] ?>" placeholder="Enter Plan"  data-parsley-required="true">
                        </div>
                        <div class="col-md-4">
              ...
              <!-- <div class="form-group m-b-10">
                        ...
                        <div class="col-md-5">
                            <input type="number" class="form-control"  name="cat_order"  value="<?= $category[0]['cat_order'] ?>" placeholder="0"  data-parsley-required="true">
                        </div>  
                        <div class="col-md-4">
                            <div class="text-danger">
              ...
              <!-- <div class="form-group m-b-10">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control"  name="cat_class"  value="<?= $category[0]['ic_class'] ?>" placeholder="fa fa-star"  data-parsley-required="true">
                        </div>  
                        <div class="col-md-4">
                            <div class="text-danger">
                                <?php echo form_error('cat_class'); ?>
                            </div>
                        </div>
                    </div> -->
...
<!-- <div class="form-group m-b-10">
                        ...
                        <div class="col-md-3">
                            ...
                            <image class="my-image" src="<?= base_url()."assets/images/CategoriesImages/".$category[0]['Image'] ?>" width="150" height="100" />
                            <?php }else{echo "<div class='text-danger'>N/A</div>";} ?>
                        </div>
                    </div> -->
                ...
                <table id="data-table"  class="table table-bordered table-hover">
                    ...
                    foreach ($categories as $item) {
                        ...
                        <tr class="odd gradeX" id="row_<?= $item['ID'] ?>">
                            ...
                            <td class="text-right">
                                <a href="<?= base_url() . "categories/EditCategories/" . $item['ID'] ?>"> <button  class="btn btn-xs btn-primary"><i class="fa fa-pencil-square-o"></i></button></a>
                                <a href="<?= base_url() . "categories/subCategories/" . $item['ID'] ?>"> <button  class="btn btn-xs btn-primary"><i class="fa fa-eye"></i> Packages</button></a>
