...
<div id="content" class="content">
    ...
    <div class="row">
        ...
        <!-- <div class="section-container section-with-top-border p-b-10"> -->
            ...
            <!-- <div class="col-md-10"> -->
                <!-- <a href="<?= base_url()."categories/subCategories"?>" class="btn btn-primary pull-right"><i class="fa fa-plus-circle"></i>Package</a> -->
            ...
            <!-- <form class="form-horizontal fv-form fv-form-bootstrap row col-md-12"  name="Category" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group m-b-10">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control"  name="cat_title" required="" value="<?php echo set_value('cat_title'); ?>" placeholder="Enter Plan"  data-parsley-required="true">
                        </div>  
                        <div class="col-md-4">
