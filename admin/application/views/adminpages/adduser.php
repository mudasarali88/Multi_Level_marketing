...
?>
    ...
    <a href="<?= base_url()."Admin/addnewuser"?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i>Add New User</a>
    <!-- end page-header -->
                    ...
                    foreach ($UserList as $item) {
                        ...
                        <tr class="odd gradeX" id="row_<?= $item['ID'] ?>">
                            ...
                            <td>
                                ...
                                <?php if($item['deletestatus']==1)
                                {
                                    ?>
                                <a href="<?= base_url() . "admin/suspend_user/" . $item['ID'] ?>"> <button  class="btn btn-xs btn-primary update">
                                ...
                                { ?>
                                    <a href="<?= base_url() . "admin/active_back/" . $item['ID'] ?>"> <button  class="btn btn-xs btn-danger update">
                                    <i class="glyphicon glyphicon-ban-circle"></i></button>
                                </a>
                            <?php } ?>
