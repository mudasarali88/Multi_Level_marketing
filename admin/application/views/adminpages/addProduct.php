...
<div id="content" class="content">
    ...
    <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group m-b-10">
                    ...
                    <label class="col-md-2 control-label">Title</label>
                        <div class="col-md-10">
                            <input type="text" class="form-control" required=""  name="product_title" value="<?php echo set_value('product_title'); ?>" placeholder="Enter product title">
                        </div>
                    </div>
        ...
        <div class="form-group m-b-10">
            ...
            <div class="col-md-5 text-left">
                <input type="text" class="form-control" required=""  name="price" value="<?php echo set_value('price'); ?>" placeholder="Enter product price">
            </div>
        </div>
</div>
        <div class="col-md-12">
 ...
 -->
                ...
                <div class="form-group m-b-10">
                    ...
                    <div class="col-md-5">
                        <textarea class="form-control"  name="product_desc" required=""><?php echo set_value('product_desc'); ?></textarea>
                    </div>
                </div>
            ...
            <div class="form-group m-b-10">
                ...
                <label class="col-md-2 control-label text-left">Home page product?</label>
                <div class="col-md-4 m-t-10">
                    Yes<input type="radio" class="" name="isHomepage" required="" value="1"> No <input type="radio" class="" name="isHomepage" required="" checked value="0">
                </div>
            </div>
